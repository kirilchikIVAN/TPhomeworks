    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/kirilchik/TechProg/Task4/GIT/TPhomeworks/task4/cmake-build-debug/cpr_repo-prefix/src/cpr_repo'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kirilchik/TechProg/Task4/GIT/TPhomeworks/task4/cmake-build-debug/cpr_repo-prefix/src/cpr_repo'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
